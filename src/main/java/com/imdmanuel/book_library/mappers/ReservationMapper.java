...
public interface ReservationMapper {
    ...
    @Mapping(target = "isActive", expression = "java(reservation.getStatus() == com.imdmanuel.book_library.models.Reservation.ReservationStatus.ACTIVE)")
    ...
    default Boolean isExpired(Reservation reservation) {
        ...
        return reservation.getExpiryDate().before(new Date())
                && reservation.getStatus() != com.imdmanuel.book_library.enums.ReservationStatus.EXPIRED;
    }
}
